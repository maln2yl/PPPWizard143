...
*
* version : $Revision: 1.1 $ $Date: 2014-08-20 12:56:43 $
...
static const char rcsid[]="$Id: ephemeris.c,v 1.1 2014-08-20 12:56:43 privata Exp $";
                      ...
                      int opt, double *rs, double *dts, double *var, int *svh)
{
    ...
    if (opt) {
        satantoff(time,rs,sat,nav->pcvs+sat-1,dant);
    }
    for (i=0;i<3;i++) {
