...
#define CODE_L1D    56                  /* obs code: B1Data     (BDS) */
#define CODE_L5D    57                  /* obs code: B2aData    (BDS) */
#define CODE_L5P    58                  /* obs code: B2aPilot   (BDS) */
#define MAXCODE     58                  /* max number of obs code */
