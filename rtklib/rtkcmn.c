...
*
* version : $Revision: 1.2 $ $Date: 2015-01-19 09:02:51 $
...
static const char rcsid[]="$Id: rtkcmn.c,v 1.2 2015-01-19 09:02:51 privata Exp $";
...
static char *obscodes[]={       /* observation code strings */
    ...
    "5B","5C","9A","9B","9C", "9X","1D","5D","5P",""    /* 50-59 */
    
};
static unsigned char obsfreqs[]={ /* 1:L1,2:L2,3:L5,4:L6,5:L7,6:L8,7:L3,8:L9 */
